...
tags: ["research", "combined", "sister", "2026", "company"]
generated:
  by: agent:hermes
  at: 2026-09-14
...
**30 names researched across 3 batches** → **12 names clear for Canadian incorporation** (40% success rate)

| Batch | Names Researched | Clear (✅) | Conflicts (❌) | Maybe/Descriptive (⚠️) |
|-------|-----------------|------------|----------------|------------------------|
| 01 | 10 | 2 | 8 | 0 |
| 02 | 10 | 5 | 3 | 2 |
| 03 | 10 | 5 | 3 | 2 |
...
## ⚠️ MAYBE / DESCRIPTIVE — Use with Caution

*These names have no direct corporate conflicts but are generic, descriptive, or weak for trademark protection.*

| Name | Batch | Issue | Recommendation |
|------|-------|-------|----------------|
| Ability Fitness | 02 | Generic term; used descriptively in occupational fitness; weak distinctiveness | Avoid — not protectable as brand |
| Inclusive Athletic Studio | 02 | Descriptive; used by vendors (Matrix Fitness) and nonprofits (ICSN); weak trademark | Avoid — descriptive |
| Inclusive Athletic Training | 03 | Generic program descriptor (used in AU, US, Canada); not distinctive | Avoid — generic |
| Accessible Athletic Center | 03 | Generic facility descriptor (colleges, hotels); not a distinctive brand | Avoid — generic |
| Accessible Fitness Center | 03 | Standard hotel amenity term; not protectable | Avoid — generic |
| Inclusive Fitness Training | 02/03 | **Generic certification term** (Infofit, ACE, Special Strong, Vagaro); industry standard phrase | **Do not use** — not a brand |

---

## ❌ CONFLICTS — Cannot Use (Existing Canadian Entities)

*These names have active Canadian corporations, trademarks, or operating businesses. **Do not pursue for incorporation.***

| Name | Batch | Conflict Details | Jurisdiction | Status |
|------|-------|------------------|--------------|--------|
| **Empower Fitness** | 01 | Operating gym — 2640 Lancaster Rd, Ottawa ON K1B 4Z4, (613) 884-9401 | Canada (ON) | Active business |
| **Access Wellness** | 01 | Nova Scotia Health government program (free counselling, launched 2023) | Canada (NS) | Gov't program |
| **Thrive Fitness** | 01 | Multiple locations: Cold Lake AB, Alliston ON, Saskatoon SK ("Why Not Thrive Fitness YXE") | Canada (AB, ON, SK) | Active businesses |
| **Elevate Performance** | 01 | **Lanark Holdings Ltd.** o/a "Elevate Performance Realty & Management" (BCFSA licensed, Squamish BC) | Canada (BC) | Incorporated |
| **Inclusive Motion** | 01 | Canadian e-commerce (inclusivemotion.com) — mobility aids retailer, "Made in Canada" | Canada | Active business |
| **Adaptive Strength** | 01 | **Adaptive Strength & Nutrition Inc.** (Edmonton AB, Yelp active 2026) | Canada (AB) | Incorporated |
| **Stride Wellness** | 01 | **Stride Wellness Consulting and Counselling Services Ltd.** (BC Corp Registry, Apr 2021) | Canada (BC) | Incorporated |
| **Compass Fitness** | 01 | Operating gym — 675 Arlington Park Pl Unit 1, Kingston ON K7M 7H8, (613) 507-8880 | Canada (ON) | Active business |
| **Active Ability Studio** | 02 | Confusingly similar to **Active Abilities Canada Inc.** (Corp #3381056, incorp. 1997-06-05, active, 10 directors, Calgary) | Canada (AB) | Incorporated |
| **Accessible Strength Training** | 02 | Generic descriptive term (equipment: HUR, Magnum ADA; class formats: Mindbody) | Canada/ROW | Generic |
| **Adaptive Strength Studio** | 03 | **Adaptive Strength Association of BC** — active nonprofit (North Bay ON), wheelchair-accessible, award-nominated | Canada (ON/BC) | Nonprofit |
| **Inclusive Fitness Training** | 02/03 | Generic certification term (Infofit, ACE Fitness, Special Strong, Vagaro, Matrix Fitness) | Canada | Generic term |
| **Accessible Fitness Center** | 03 | Generic hotel/facility amenity term (DoubleTree, Westin, Residence Inn, Four Points) | Canada/ROW | Generic |
| **Active Abilities Canada Inc.** | — | Existing corporation blocking "Active Ability" variants | Canada (AB) | Incorporated 1997 |

---

## 📋 COMPLETE NAME INVENTORY — All 30 Names by Batch

### Batch 01 (Original 10)
| # | Name | Status | Notes |
|---|------|--------|-------|
...
1. **Order NUANS reports** for top 5 names above (required for federal/Ontario/Alberta incorporation) — ~$30 each, 24–48 hr turnaround via CorpCentre, NUANS Canada, or Ownr.

2. **Review NUANS results** — confirm no "confusingly similar" names in federal/provincial registries or trademarks database.
...
**Sources searched:**
- Corporations Canada (federal CBCA registry)
